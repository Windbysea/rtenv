...
void first()
{
	...
	if (!fork()) setpriority(0, PRIORITY_DEFAULT - 10), shell_interface_task();
	//if (!fork()) setpriority(0, PRIORITY_DEFAULT - 10), test_tesk();
